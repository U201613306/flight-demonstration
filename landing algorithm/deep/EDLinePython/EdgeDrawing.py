...
# ed = EdgeDrawing()
# img_path = "image/test/cut_result_23235232/img_SimpleFlight__0_1629733952602274000.png"

# image = cv2.imread(img_path)
# image_gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)

# edges,edge_map = ed.EdgeDrawing(image_gray, False)
